...
INSERT INTO OB_CONSENT_METADATA (SELECT ID AS CONSENT_ID, 'PISP' AS CONSENT_TYPE, 'PaymentType' AS METADATA_KEY, REQUEST->>'$.paymentType' AS METADATA_VALUE FROM UK_TRANSACTION_INITIATION);

COMMIT;

ALTER TABLE UK_NOTIFICATION_CALLBACK DROP URL;
ALTER TABLE UK_NOTIFICATION_CALLBACK DROP VERSION;
